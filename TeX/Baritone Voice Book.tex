...
\includepdf[pages=-, pagecommand={\thispagestyle{plain}}]{"../Baritone Voice/Is You Is or Is You Ain't (Ma' Baby) - Ly - Am Baritone Voice"}

\clearemptytoevenpage

\phantomsection
\addcontentsline{toc}{section}{It's All Right With Me - Bb}
\includepdf[pages=-, pagecommand={\thispagestyle{plain}}]{"../Baritone Voice/It's All Right With Me - Ly - Bb Baritone Voice"}
...
\phantomsection
\addcontentsline{toc}{section}{It's All Your Fault - Eb}
\includepdf[pages=-, pagecommand={\thispagestyle{plain}}]{"../Baritone Voice/It's All Your Fault - Ly - Eb Baritone Voice"}
