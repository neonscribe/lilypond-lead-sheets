...
\phantomsection
\addcontentsline{toc}{section}{Este Seu Olhar - F Bass}
...
\phantomsection
\addcontentsline{toc}{section}{I Ain't Gonna Give Nobody None O' This Jelly Roll - Bb Bass}
\includepdf[pages=-, pagecommand={\thispagestyle{plain}}]{"../Standard/Bass/I Ain't Gonna Give Nobody None O' This Jelly Roll - Ly - Bb Bass for Standard"}
...
\phantomsection
\addcontentsline{toc}{section}{I Cover the Waterfront - G Bass}
\includepdf[pages=-, pagecommand={\thispagestyle{plain}}]{"../Standard/Bass/I Cover the Waterfront - Ly - G Bass for Standard"}
...
\includepdf[pages=-, pagecommand={\thispagestyle{plain}}]{"../Standard/Bass/My Buddy Swing - Ly - F Bass for Standard"}
...
\phantomsection
\addcontentsline{toc}{section}{Spring Is Here (Bill Evans) - Ab Bass}
