...
verseLyrics = \lyricmode {
  ...
  as __ mer -- ry as a car -- ou -- sel. __

  The cir -- cus tent was strung __ with ev -- 'ry star in the sky
  a -- bove the ring __ I loved so well. __
...
refrainLyrics = \lyricmode {
  Sit there and count your fin -- gers. What can you do?
  ...
  is the rain -- drops that fall on lit -- tle girl blue. __

  No use, old girl, you may as well sur -- ren -- der.
  Your hope is get -- ting slen -- der.
  Why won't some -- bod -- y send a ten -- der blue boy
  to cheer a lit -- tle girl blue? __
}
...
refrainMelody = \relative f' {
  ...
  \xTextMark \markup{ "Refrain" \box \bold "A1" }
