...
dressed up in their Sun -- day best clothes up and down Broad _ _ "- way."
}
...
refrainMelody = \relative f' {
  ...
  \bar ".|:"
  \repeat volta 2 {
  f8 ef8 r4 r4 f8 ef8 | r2 f8 ef8 f8 ef8 | f8 ef8 r4 r4 f8 ef8 |
  \break
  r2 f8 ef8 f8 ef8 | g8 bf4.~ bf4 g8 bf,8~ | bf2 gf'8 gf8 f8 f8~ |
  \break
  \alternative { \volta 1 {
  f8 ef4. r2 | r1 |
  } \volta 2 {
