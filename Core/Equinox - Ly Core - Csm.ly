...
songID = "2026-06-01T22:16:32.747129Z"
...
refrainMelody = \relative f' {
  ...
  \clef \whatClef
  \tempoFour "Medium [John Coltrane 1960]" 117

  \sectNoBarNoBreak "Piano Intro"

  \bar ".|:"
  \repeat volta 2 {
    cs4_"(play 3x)" r4 gs'8 cs,8 b'8 cs,8 | fs4 r4 e8 cs8 fs8 b,8 |
  }
  ...
  \sectNoBar "Bass Intro"

  cs4. cs8~ cs4 cs4~ |
  cs2 gs4 b4 |

  cs4. cs8~ cs4 cs4~ |
  cs2_"(continue similar)" r4 r8 gs'8_"(head)" |
...
bassLineMelody = \relative f' {
  ...
  \bar ":|.|:"
  \repeat volta 2 {
    cs,4._"(bass)" cs8~ cs4 cs4~ | cs2 gs4 b4 | cs4. cs8~ cs4 cs4~ | cs2 cs4 e4 |
